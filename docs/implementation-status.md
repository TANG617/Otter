...
| App/unit/UI targets | Xcode project targets | 111 unit tests passed; 5 iPhone and 2 iPad local UI flows passed; iOS 18.5 CI smoke passed | Complete | Three opt-in live tests skip without environment credentials. Broader iPad iOS 18 validation remains a release gate. |
...
- GitHub Actions: Xcode 16.4 / iPhone 16 Pro / iOS 18.5 dependency resolution, generic build, unit tests, and key fixture UI smoke passed ([run 31377026122](https://github.com/TANG617/Otter/actions/runs/31377026122)).
